...
public class Draw {
	...
	int x = 0;
	g2d.drawString("Score: " + (int)Airport.getScoreArray()[SCORE.PLYRSCORE.getSID()], x, y);
	y+=fm.getHeight();
	int ski = (int)(Airport.getScoreArray()[SCORE.PLYRSKILL.getSID()] * 100);
	float sk = (float)ski / 100;
	g2d.drawString("Skill: " + sk, x, y);
	y+=fm.getHeight();
	g2d.drawString("Arrived: " + (int)Airport.getScoreArray()[SCORE.ARRIVED.getSID()], x, y);
	y+=fm.getHeight();
	g2d.drawString("Landed: " + (int)Airport.getScoreArray()[SCORE.LANDED.getSID()], x, y);
	y+=fm.getHeight();
	g2d.drawString("Departed: " + (int)Airport.getScoreArray()[SCORE.DEPARTED.getSID()], x, y);
	y+=fm.getHeight();
	g2d.drawString("Cruised: " + (int)Airport.getScoreArray()[SCORE.CRUISEALT.getSID()], x, y);
	y+=fm.getHeight();
	g2d.drawString("Handoffs: " + (int)Airport.getScoreArray()[SCORE.HANDOFF.getSID()], x, y);
	y+=fm.getHeight();
	g2d.drawString("Missed Handoff: " + (int)Airport.getScoreArray()[SCORE.HANDOFFMISS.getSID()], x, y);
	y+=fm.getHeight();
	g2d.drawString("Left Airspace: " + (int)Airport.getScoreArray()[SCORE.OUTOFSEC.getSID()], x, y);
	y+=fm.getHeight();
	g2d.drawString("Sep. Incident Time: " + (int)Airport.getScoreArray()[SCORE.SEPINCTIME.getSID()], x, y);
	y+=fm.getHeight();
